...
const About = () => {
  ...
  useEffect(() => {
    const fetchAboutContent = async () => {
      const aboutRef = ref(database, 'account/about'); // Reference to the 'account/about' node
    ...
    <section id='about'>
      <div className="bg-blue2 pt-10">
        <div className='max-w-60 mx-auto '>
          <h2 className="text-lg font-thin text-center bg-main3 text-white p-2 uppercase">About Us</h2>
        </div>
