  ...
  return (
    <section className="w-full mx-auto p-0 mb-2">
      <div className="flex flex-col md:flex-row gap-1">
        ...
        <div className="flex-1 relative w-full h-[24rem] md:h-[40.2rem]"> {/* Adjust height for mobile */}
          <Image
        ...
        <div className="flex-1 grid grid-cols-2 gap-1">
          <div className="relative w-full h-[12rem] md:h-[20rem]"> {/* Adjust height for mobile */}
            <Image
