...
const Vision = () => {
  return (
    <div className="relative parallax  min-h-80 bg-top" style={{ backgroundImage: "url('/images/divaris.jpeg')" }}>
      ...
      <div className="relative max-w-7xl mx-auto z-10 flex flex-col md:flex-row items-center justify-between h-full text-white p-4">
        <div className="flex-1 text-center  p-4">
          ...
          <p className="mt-4 text-xl max-w-3xl font-thin">
            <b>To be a trailblazer in the provision of quality education.</b> Being a centre for educational excellence nationally, regionally and internationally, offering the best quality in the areas of academics, sports, social and cultural activities.
          </p>
        </div>
        <div className="flex-1 text-center  p-4">
